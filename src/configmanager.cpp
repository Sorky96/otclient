...
std::array<uint64_t, ConfigManager::LAST_INTEGER_CONFIG> integer = {};
...
uint64_t ConfigManager::getNumber(integer_config_t what)
{
...
bool ConfigManager::setNumber(integer_config_t what, uint64_t value)
{
	if (what >= LAST_INTEGER_CONFIG) {
