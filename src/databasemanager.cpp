...
uint64_t DatabaseManager::getDatabaseVersion()
{
...
bool DatabaseManager::getDatabaseConfig(const std::string& config, uint64_t& value)
{
	Database& db = Database::getInstance();
...
void DatabaseManager::registerDatabaseConfig(const std::string& config, uint64_t value)
{
	Database& db = Database::getInstance();
