...
private:
	...
	static constexpr uint32_t GAME_SUNRISE = 360;
	static constexpr uint32_t GAME_DAYTIME = 480;
	static constexpr uint32_t GAME_SUNSET = 1080;
	static constexpr uint32_t GAME_NIGHTTIME = 1200;
