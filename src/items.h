...
struct Abilities
{
	...
	std::array<uint32_t, COMBAT_COUNT> fieldAbsorbPercent = {0};

	// damage abilities modifiers
	std::array<uint32_t, COMBAT_COUNT> absorbPercent = {0};

	std::array<Reflect, COMBAT_COUNT> reflect;

	uint32_t boostPercent[COMBAT_COUNT] = {0};
